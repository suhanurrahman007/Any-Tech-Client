...
const NewSetup = () => {
  const t = useTranslations("NewSetup"); // Fetch translations for features section
      ...
      <div className="hidden lg:grid grid-cols-1 md:grid-cols-3 gap-6">
        {features.map((feature, index) => (
          <div
            ...
            key={index}
            className="p-10 bg-[#EBF4FF] border border-blue-500 rounded-2xl space-y-4 transition-all duration-300 flex flex-col"
          >
            <div
