...
import future from "@/assets/images/f3.avif";
import futureIcon1 from "@/assets/images/f2.avif";
import futureIcon3 from "@/assets/images/f1.svg";
import bannerBg from "@/assets/images/ctaMobileWaveLines.svg";

export default function Consult() {
  const t = useTranslations("Consult"); // Get translations
  ...
  return (
    <div className="relative flex flex-wrap gap-5 md:gap-0 justify-between items-center px-6 sm:px-8 md:px-12 lg:px-16 py-6 bg-white">
      ...
      >
        ...
        <motion.div
          className="absolute lg:top-12 lg:left-12 top-0 left-0 w-36 h-36 flex items-center justify-center z-20"
          initial={{ y: -10 }}
          animate={{ y: [-10, 10, -10] }}
