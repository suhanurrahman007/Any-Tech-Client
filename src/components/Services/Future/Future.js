...
import future from "@/assets/images/sbg.avif";
  ...
  return (
    <div className="relative flex flex-wrap gap-5 md:gap-0 justify-between items-center px-6 sm:px-8 md:px-12 lg:px-16 py-6 bg-white">
      ...
      >
        ...
        <motion.div
          className="absolute lg:bottom-1/4 md:bottom-1/4 bottom-1/4 lg:left-10 left-0 w-20 h-20 shadow-md rounded-full flex items-center justify-center z-20"
          initial={{ y: -10 }}
          animate={{ y: [-10, 10, -10] }}
