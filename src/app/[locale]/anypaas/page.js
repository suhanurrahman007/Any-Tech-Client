...
export default function AnyPaaS() {
  return (
    <div className="">
      <Helmet>
        <title>Any PaaS | Any Tech</title>
      </Helmet>
      {/* Background Wrapper */}
      <div className="relative w-full h-screen text-white">
        ...
        <div className="absolute inset-0 w-full h-full">
          ...
          <div className="relative w-full h-screen">
            ...
            <div className="absolute top-[-150px] left-[-220px] w-full h-full opacity-80 bg-gradient-to-b from-[#00bcd4] to-[#2aa9d9] rotate-[-45deg] pointer-events-none"></div>

            <div className="absolute top-[-150px] left-[-220px] w-full h-full opacity-80 bg-gradient-to-b from-[#00bcd4] to-[#2aa9d9] rotate-[-45deg] pointer-events-none"></div>

            <div className="absolute w-full h-full opacity-80 bg-gradient-to-b from-cyan-700 pointer-events-none"></div>
            <div className="absolute w-full h-full opacity-80 bg-gradient-to-b from-cyan-700 pointer-events-none"></div>
          </div>
