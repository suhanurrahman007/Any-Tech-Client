...
export default function AnyCaaS() {
  return (
    <div className="">
      <Helmet>
        <title>Any CaaS | Any Tech</title>
      </Helmet>
      {/* Background Wrapper */}
      <div className="relative w-full h-screen text-white">
        ...
        <div className="absolute inset-0 w-full h-full">
          ...
          <div className="relative w-full h-screen">
            ...
            <div className="absolute top-[-150px] left-[-220px] w-full h-full opacity-80 bg-gradient-to-b from-[#008000] to-[#2a9d23] rotate-[-45deg] pointer-events-none"></div>

            <div className="absolute top-[-150px] left-[-220px] w-full h-full opacity-80 bg-gradient-to-b from-[#008000] to-[#2a9d23] rotate-[-45deg] pointer-events-none"></div>

            <div className="absolute w-full h-full opacity-80 bg-gradient-to-b from-green-700 pointer-events-none"></div>
            <div className="absolute w-full h-full opacity-80 bg-gradient-to-b from-green-700 pointer-events-none"></div>
          </div>
